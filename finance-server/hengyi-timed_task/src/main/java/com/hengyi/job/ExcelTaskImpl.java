...
public class ExcelTaskImpl implements ExcelTask{
     ...
     * @throws Exception
     */
//    @Scheduled(cron = "00 45 21 * * ?")
    @Scheduled(cron = "00 00 11 * * ?")
    @Override
    public void importexcel() throws Exception {
        System.out.println("开始导入预算数据到budgetdetail表");
...
//                                System.out.println(ExcelUtil.changetostring(cell));
...
//                      }
        ...
        System.out.println("导入数据结束时间："+df.format(day));
...
//        }
    ...
    public void importexcel2() throws Exception {
        System.out.println("开始导入预算数据到budgetdetailadd表");
//        File file = new File("D:\\work\\预算数据整理\\六家公司_预算单耗&单价_20180404中午.xlsx");
        String path="C:\\Users\\Administrator\\Desktop\\finance\\importExcel";
        File directory = new File(path);
        String[] files=directory.list();
